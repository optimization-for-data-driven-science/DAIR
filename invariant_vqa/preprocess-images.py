...
def main():  # main(args):
    ...
    loader =  create_coco_loader(config.train_path, config.val_path, config.test_path, config.del1_path_train, config.del1_path_val,config.edit_train_path, config.edit_val_path )
    features_shape = (
        len(loader.dataset),
