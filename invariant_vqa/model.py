        ...
        if config.vis_attention:
            ...
            if config.qa_path == '/BS/vedika2/nobackup/thesis/CVPR_REBUTTAL_JSON/orig_qa':
                if config.fintuned_model_test:
                    ...
                    saaa_vqa = '../pytorch-vqa/cvpr_rebuttal_finetuned_SAAA_orig_vqa_attention.pickle'
                else:
                    saaa_vqa = '../pytorch-vqa/cvpr_rebuttal_SAAA_orig_vqa_attention.pickle'
            elif config.qa_path == '/BS/vedika2/nobackup/thesis/CVPR_REBUTTAL_JSON/edit_qa':
                if config.fintuned_model_test:
                    assert 'finetuning' in config.model_path_show_ask_attend_answer
                    saaa_vqa = '../pytorch-vqa/cvpr_rebuttal_finetuned_SAAA_edit_vqa_attention.pickle'
                else:
                    saaa_vqa = '../pytorch-vqa/cvpr_rebuttal_SAAA_edit_vqa_attention.pickle'
